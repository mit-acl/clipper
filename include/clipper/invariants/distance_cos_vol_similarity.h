...
namespace invariants {
   ...
   */
  class DistanceCosVolSimilarity : public DistancePairwiseAndSingle
  {
  public:
    DistanceCosVolSimilarity(const Params& params)
    : DistancePairwiseAndSingle(params), params_(params)
    {}
    ~DistanceCosVolSimilarity() = default;
  ...
  using DistanceCosVolSimilarityPtr = std::shared_ptr<DistanceCosVolSimilarity>;
