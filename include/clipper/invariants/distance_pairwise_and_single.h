...
namespace invariants {
   ...
   */
  class DistancePairwiseAndSingle : public PairwiseAndSingleInvariant
  {
  public:
  ...
  public:
    ...
    : params_(params) 
    {}
    ~DistancePairwiseAndSingle() = default;
  ...
  using DistancePairwiseAndSinglePtr = std::shared_ptr<DistancePairwiseAndSingle>;
