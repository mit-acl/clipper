/**
 * @file distance_cos_similarity.h
...
namespace invariants {
   ...
   */
  class DistanceScaleSimilarity : public DistancePairwiseAndSingle
  {
  public:
    DistanceScaleSimilarity(const Params& params)
    : DistancePairwiseAndSingle(params), params_(params)
    {}
    ~DistanceScaleSimilarity() = default;
  ...
  using DistanceScaleSimilarityPtr = std::shared_ptr<DistanceScaleSimilarity>;
