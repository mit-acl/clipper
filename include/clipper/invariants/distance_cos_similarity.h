...
namespace invariants {
   ...
   */
  class DistanceCosSimilarity : public DistancePairwiseAndSingle
  {
  public:
    DistanceCosSimilarity(const Params& params)
    : DistancePairwiseAndSingle(params), params_(params)
    {}
    ~DistanceCosSimilarity() = default;
  ...
  using DistanceCosSimilarityPtr = std::shared_ptr<DistanceCosSimilarity>;
